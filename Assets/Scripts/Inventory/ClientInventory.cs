...
public class ClientInventory : NetworkBehaviour
{
    ...
    public void CollectItem(int itemId)
    {
        ...
        ServerInventory.Instance().AddItemToInventory(itemId, GetComponent<NetworkIdentity>().netId);
    }
    ...
    public void DropItemCmd(int itemIndex, int itemId)
    {
        ...
        ServerInventory.Instance().RemoveItemFromInventoryByIndex(itemIndex, GetComponent<NetworkIdentity>().netId);
    ...
    ItemSlot[] Slots()
    {
        return ServerInventory.Instance().Get(GetComponent<NetworkIdentity>().netId).slots;
    }
}
